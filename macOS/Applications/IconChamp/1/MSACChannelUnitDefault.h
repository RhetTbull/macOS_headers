...
#import "MSACChannelUnitProtocol-Protocol.h"

@class MSACChannelUnitConfiguration, NSHashTable, NSMutableArray, NSMutableSet, NSString;
@protocol MSACIngestionProtocol, MSACStorage, OS_dispatch_queue, OS_dispatch_source;
