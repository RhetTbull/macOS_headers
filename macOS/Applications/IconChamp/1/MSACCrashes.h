...
#import "MSACServiceInternal-Protocol.h"

@class MSACChannelUnitConfiguration, MSACEncrypter, MSACErrorReport, MSPLCrashReporter, NSDate, NSMutableArray, NSObject, NSString;
@protocol MSACChannelGroupProtocol, MSACChannelUnitProtocol, MSACCrashesDelegate, OS_dispatch_group, OS_dispatch_queue, OS_dispatch_semaphore, OS_dispatch_source;
